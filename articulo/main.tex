...
\and
\IEEEauthorblockN{Pavel Zambrano Gomez}
\IEEEauthorblockA{Universidad del Valle\\
Email:pavel.zambrano@correounivalle.edu.co}
\and
...
\input{trabajo-relacionado}

\input{intro-despliegue}
  \input{despliegue/docker}
  \input{despliegue/lxc}
  \input{despliegue/coreos}
  \input{despliegue/baremetal}

\input{benchmarking}

\input{entorno-pruebas}
